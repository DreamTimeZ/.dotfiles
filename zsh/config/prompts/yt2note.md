...
- **Punctuation**: outside code, paths, URLs, flags, tables, and math, never use em dashes, en dashes, or semicolons. Rewrite with commas, colons, periods, or parentheses.
