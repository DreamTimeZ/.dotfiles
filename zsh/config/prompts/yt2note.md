...
- **Punctuation**: never use em dashes, en dashes, or semicolons in prose, including code comments. Code itself is exempt. Hyphens in compound words are allowed. Rewrite with commas, colons, periods, or parentheses.
