# Generated by Powerlevel10k configuration wizard on 2025-03-04 at 10:37 CET.
...
() {
  ...
  # Custom colors (From my Oh-My-Posh Theme)
  local lime_green='#B8FF75'         # Status & Execution Time
  local soft_red='#E06C75'           # Shell, Root Indicator (!), Lambda Symbol (λ)
  local warm_yellow='#E5C07B'        # User@Host (Session)
  local golden_yellow='#F3C267'      # Git Branch Name
  local bright_orange='#FF9248'      # Git Changes (Modified/Unstaged)
  local deep_orange='#FF4500'        # Git Conflict (Ahead & Behind)
  local soft_purple='#B388FF'        # Git Ahead/Behind
  local sky_blue='#61AFEF'           # Directory Path
  local green='#5FAF5F'
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=$lime_green

  # Grey Git prompt. This makes stale prompts indistinguishable from up-to-date ones.
  typeset -g POWERLEVEL9K_VCS_FOREGROUND=$golden_yellow
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=$bright_orange
